...
class CustomTimeFormatter {
  static String toYearMonthDateFormat(String? dateTime) {
    return DateFormat('yyyy-MM-dd', GetContext.context.locale.languageCode)
  ...
  static String toDateMonthFormat(String? dateTime) {
    return DateFormat('dd MMM', GetContext.context.locale.languageCode)
        .format(DateTime.parse(dateTime ?? DateTime.now().toString()));
    // something like 2023-12-30
  }

  static String toDotDateMonthYearTimeFormat(DateTime? dateTime) {
    return DateFormat(
            'dd.MM.yyyy HH:mm', GetContext.context.locale.languageCode)
        .format(dateTime ?? DateTime.now());
    // something like 26 Nov 2023, 12:10
  }
  static String toDateMonthYearTimeFormat(DateTime? dateTime) {
    return DateFormat(
            'dd MMM yyyy, HH:mm', GetContext.context.locale.languageCode)
        .format(dateTime ?? DateTime.now());
    // something like 26 Nov 2023, 12:10
  }

  static String toDDMMYY(DateTime? dateTime) {
    return DateFormat('dd MMM yyyy', GetContext.context.locale.languageCode)
        .format(dateTime ?? DateTime.now());
    // something like 26 Nov 2023, 12:10
  }
  ...
  static String toDDMMYYYYFormat(String? dateTime) {
    return DateFormat('dd.MM.yyyy', GetContext.context.locale.languageCode)
        .format(DateTime.parse(dateTime ?? DateTime.now().toString()));
    // something like 12 Sep, 2023
  }
  ...
  static DateTime? dateConverter(date) {
  ...
  static DateTime replaceDate(String originDateTime, DateTime newDate) {
    ...
    final utcDateTime = DateTime.parse(originDateTime).toUtc();
  ...
  static String timeHM(String? dateTime) {
    try {
      ...
      final DateFormat formatter =
          DateFormat('HH:mm', GetContext.context.locale.toString());
      final String formatted = formatter.format(date);
      return formatted;
    } catch (e) {
      return "Running";
  ...
  static String date(String dateTime) {
    DateTime date = DateTime.parse(dateTime);
    final DateFormat formatter =
        DateFormat('dd-MM-yyyy', GetContext.context.locale.languageCode);
    final String formatted = formatter.format(date);
  ...
  static String dateMonth(String dateTime) {
    DateTime date = DateTime.parse(dateTime);
    final DateFormat formatter =
        DateFormat('MMM.dd', GetContext.context.locale.languageCode);
    final String formatted = formatter.format(date);
  ...
  static String month(String dateTime) {
    DateTime date = DateTime.parse(dateTime);
    final DateFormat formatter =
        DateFormat('MMMM', GetContext.context.locale.languageCode);
    final String formatted = formatter.format(date);
    return formatted; // something like 2013-04-20
  }
  ...
  static String dateYear(String dateTime) {
    DateTime date = DateTime.parse(dateTime);
    final DateFormat formatter =
        DateFormat('MMMM yyyy', GetContext.context.locale.languageCode);
    final String formatted = formatter.format(date);
    return formatted; // something like 2013-04-20
  }
...
extension DateTimeExtension on DateTime? {
  ...
  bool isBetween(DateTime startDate, DateTime endDate) {
    final isAfter = isAfterOrEqualTo(startDate) ?? false;
    final isBefore = isBeforeOrEqualTo(endDate) ?? false;
    return isAfter && isBefore;
  }
}

extension DateParsingExtension on String? {
  String toYearMonthDateFormat() {
